"""
Models for MindMate Chatbot - External Backend
"""
...
class ChatSession(models.Model):
    ...
    registered_user = models.ForeignKey(User, on_delete=models.CASCADE, null=True, blank=True)  # For registered users
...
class UserProfile(models.Model):
    ...
    registered_user = models.OneToOneField(User, on_delete=models.CASCADE, null=True, blank=True)  # For registered users
