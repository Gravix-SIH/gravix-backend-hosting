#!/usr/bin/env python3
"""
MindMate Mental Health Chatbot - Simple CLI Interface
...
def analyze_triggers(message: str) -> str:
    """Analyze message for booking and resource triggers (assessments now handled by chatbot)."""
...
def main():
    ...
    # Initialize chatbot and assessment API client
    chatbot = MindMateChatbot(api_key)
    assessment_client = AssessmentAPIClient()
    current_assessment = None

    # Welcome message per claude.md spec
    ...
    while True:
        try:
            ...
            if user_input.lower() in ['quit', 'exit', 'bye']:
                ...
                mood_data = chatbot.get_mood_summary()
                if mood_data:
                ...
                if assessment_choice == '1':
                    ...
                    print("\nAfter completing the external assessment, you can share the results with me for analysis.")
                else:
                ...
                print("1. Assessment type (PHQ-9 or GAD-7)")
                print("2. Total score")
                print("3. Individual responses (optional)")
                ...
                try:
                    ...
                    analysis = chatbot.analyze_assessment_results(assessment_type, total_score, responses)
                    print(f"\nMindMate: {analysis}")
            ...
            try:
                ...
                # Check for remaining triggers (booking and resources)
                # Assessment suggestions are now handled by the chatbot's post-processing
