...
from .views import health_check, chat_endpoint, conversation_history, mood_summary, create_new_session, get_all_sessions, delete_session
...
urlpatterns = [
    ...
    path('chat/<str:session_id>/', delete_session, name='delete-session'),
