...
def update_session_title(request, session_id):
    ...
    try:
        ...
        # Store the custom title in session metadata or create a custom title field
        # For now, we'll create a simple approach by updating the first user message
        # Or we could add a title field to the model later
